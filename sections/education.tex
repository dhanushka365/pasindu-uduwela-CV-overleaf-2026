...
%      {Institution of Study}{Where it is located}
 \CVSubheading
      {{BSc. Eng. (Hons) in Computer Engineering $|$ \emph{\small{Minor: Data Management }}}}{2019 -- 2023}
 ...
 \CVSubheading
      ...
      Result: 7 Distinctions (7 A's) and 2 Very Good passes (2 B's), including ICT\\
      \textbf{\scriptsize
            \faEnvelope\ \href{https://drive.google.com/file/d/1vODNH0og1OdqX_hrQJvhk1H7Zwhpah3k/view?usp=sharing}{\textcolor{gray}{Degree Certificate}}%
            \hspace{1.5em}%
            \faEnvelope\ \href{https://drive.google.com/file/d/1VoPAvyuVye-_lwg4icO9Algy3Sm8JZyc/view?usp=sharing}{\textcolor{gray}{Academic Transcript}}
        }\\
        {\color{gray!40}\dotfill} % <-- very light dotted line
      }
