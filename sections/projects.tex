...
\section{Projects and Research}
  \CVSubHeadingListStart
    ...
    \CVSubheading
      ...
      \end{itemize}
      \techlist{Technologies}{%
        \techcard{Angular} \techcard{.NET Core} \techcard{C\#} \techcard{RESTful API} \techcard{Docker} \techcard{Swagger} \techcard{Role-based Access Control} \techcard{Image Upload} \techcard{Search \& Filter}%
      }
